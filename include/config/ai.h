...
#define EXPLOSION_HIGHER_HP_THRESHOLD                           100 // HP percentage at or above which the AI has a 0% chance to explode; otherwise scales between this and lower threshold
