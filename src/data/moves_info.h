...
const struct MoveInfo gMovesInfo[MOVES_COUNT_ALL] =
{
    ...
    [MOVE_HYPER_BEAM] =
    {
        ...
        .description = COMPOUND_STRING(
            "A beam of pure force slams the\n"
            "foe and may reduce Sp. Defense."),
        .effect = EFFECT_HIT,
        .power = 85,
        .type = TYPE_NORMAL,
        .accuracy = 100,
    ...
    [MOVE_SUBMISSION] =
    {
        ...
        .additionalEffects = ADDITIONAL_EFFECTS({
			.moveEffect = MOVE_EFFECT_WRAP,
			.multistring.wrapped = B_MSG_WRAPPED_SUBMISSION,
		}),
        .contestEffect = CONTEST_EFFECT_USER_MORE_EASILY_STARTLED,
        .contestCategory = CONTEST_CATEGORY_COOL,
        .contestComboStarterId = 0,
    ...
    [MOVE_SELF_DESTRUCT] =
    {
        ...
        .effect = EFFECT_RECOIL,
        .power = B_UPDATED_MOVE_DATA >= GEN_2 ? 80 : 130,
        .type = TYPE_ROCK,
        .accuracy = 100,
        .pp = 2,
        .target = TARGET_FOES_AND_ALLY,
    ...
    [MOVE_CONVERSION_2] =
    {
        .name = COMPOUND_STRING("Slobbery Chomp"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_WHIRLPOOL] =
    {
        ...
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_5 ? 65 : 15,
        .type = TYPE_WATER,
    ...
    [MOVE_SWALLOW] =
    {
        ...
        .description = COMPOUND_STRING(
            "Swallows the foe and digests\n"
            "them for "BINDING_TURNS" turns"),
        .effect = EFFECT_HIT,
        .power = 65,
        .type = TYPE_POISON,
        .accuracy = 100,
		...
		.additionalEffects = ADDITIONAL_EFFECTS({
			.moveEffect = MOVE_EFFECT_WRAP,
			.multistring.wrapped = B_MSG_WRAPPED_SWALLOW,
		}),
    ...
    [MOVE_TAIL_GLOW] =
    {
        ...
        .description = COMPOUND_STRING(
            "Flashes and sharply raises\n"
            "Sp. Atk. and lowers Evasion."),
        .effect = EFFECT_STAT_CHANGE,
        .power = 0,
        .type = TYPE_BUG,
        .accuracy = 0,
    ...
    [MOVE_BLAST_BURN] =
    {
        ...
        .description = COMPOUND_STRING(
            "Gouts of flame engulf the foe\n"
            "and may shaply reduce Attack."),
        .effect = EFFECT_HIT,
        .power = 85,
        .type = TYPE_FIRE,
        .accuracy = 100,
    ...
    [MOVE_HYDRO_CANNON] =
    {
        ...
        .description = COMPOUND_STRING(
            "Jets of water pound the foe and\n"
            "may sharply reduce Sp. Attack."),
        .effect = EFFECT_HIT,
        .power = 85,
        .type = TYPE_WATER,
        .accuracy = 100,
    ...
    [MOVE_SHEER_COLD] =
    {
        ...
        .description = COMPOUND_STRING(
            "The temperature drops tremendously.\n"
            "Harhshly lowers the Sp. Atk."),
        .effect = EFFECT_HIT,
        .power = 130,
        .type = TYPE_ICE,
        .accuracy = 90,
    ...
    [MOVE_FRENZY_PLANT] =
    {
        ...
        .description = COMPOUND_STRING(
            "Vines writhe and trip the foe\n"
            "and may sharply reduce speed."),
        .effect = EFFECT_HIT,
        .power = 85,
        .type = TYPE_GRASS,
        .accuracy = 100,
    ...
    [MOVE_GASTRO_ACID] =
    {
        ...
        .description = COMPOUND_STRING(
            "Attempts to digest the foe\n"
            "to steal 3/4 the damage done."),
        .effect = EFFECT_ABSORB,
        .power = 50,
        .type = TYPE_POISON,
        .accuracy = 100,
    ...
    [MOVE_ROCK_WRECKER] =
    {
        ...
        .description = COMPOUND_STRING(
            "Shoots rocks at the foe and\n"
            "may sharply reduce Defense."),
        .effect = EFFECT_HIT,
        .power = 85,
        .type = TYPE_ROCK,
        .accuracy = 100,
    ...
    [MOVE_CAPTIVATE] =
    {
        ...
        .description = COMPOUND_STRING(
            "Puts on a show to sharply\n"
            "reduce the foes Sp. Atk."),
        .effect = EFFECT_STAT_CHANGE,
        .power = 0,
        .type = TYPE_NORMAL,
        .accuracy = 100,
    ...
    [MOVE_SEED_FLARE] =
    {
        ...
        .description = COMPOUND_STRING(
            "Does Grass and Fire type damage\n"
            "and may burt the target."),
    ...
    [MOVE_DRAINING_KISS] =
    {
        ...
        .description = COMPOUND_STRING(
            "An attack that absorbs three\n"
            "quarters the damage inflicted."),
        .effect = EFFECT_ABSORB,
        .power = 50,
        .type = TYPE_FAIRY,
        .accuracy = 100,
    ...
    [MOVE_HOLD_HANDS] =
    {
        ...
        .description = COMPOUND_STRING(
            "The user and foe hold hands\n"
            "making them happy and confused."),
        .effect = EFFECT_CONFUSE,
        .power = 0,
        .type = TYPE_FAIRY,
        .accuracy = 100,
		...
		[MOVE_CHILL_TOUCH] =
    {
	    ...
	    [MOVE_ALOE_SLAP] =
    {
        .name = COMPOUND_STRING("Aloe Slap"),
        .description = COMPOUND_STRING(
            "Powerful against burned\n"
            "foes, but also heals them."),
        .effect = EFFECT_DOUBLE_POWER_ON_ARG_STATUS,
        .power = 70,
        .type = TYPE_GRASS,
        ...
        .contestCategory = C_UPDATED_MOVE_CATEGORIES >= GEN_6 ? CONTEST_CATEGORY_TOUGH : CONTEST_CATEGORY_SMART,
        .contestComboStarterId = 0,
        .contestComboMoves = {COMBO_STARTER_FIRE_PUNCH, COMBO_STARTER_WILL_O_WISP, COMBO_STARTER_FIRE_FANG},
        .battleAnimScript = gBattleAnimMove_IvyCudgel,
        .validApprenticeMove = TRUE,
    },
		...
		[MOVE_TINCTURE] =
    {
        .name = COMPOUND_STRING("Tincture"),
        .description = COMPOUND_STRING(
            "Powerful against poisoned\n"
            "foes, but also heals them."),
        .effect = EFFECT_DOUBLE_POWER_ON_ARG_STATUS,
        .power = 70,
        .type = TYPE_FAIRY,
        ...
        .contestCategory = C_UPDATED_MOVE_CATEGORIES >= GEN_6 ? CONTEST_CATEGORY_TOUGH : CONTEST_CATEGORY_SMART,
        .contestComboStarterId = 0,
        .contestComboMoves = {COMBO_STARTER_POISON_GAS, COMBO_STARTER_TOXIC},
        .battleAnimScript = gBattleAnimMove_MatchaGotcha,
        .validApprenticeMove = TRUE,
    },
		...
		[MOVE_MELTDOWN] =
    {
        ...
        .priority = 0,
        .category = DAMAGE_CATEGORY_PHYSICAL,
        .argument = { .status = STATUS1_FROSTBITE },
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_REMOVE_STATUS,
        }),
        .contestEffect = C_UPDATED_MOVE_EFFECTS >= GEN_6 ? CONTEST_EFFECT_AFFECTED_BY_PREV_APPEAL : CONTEST_EFFECT_STARTLE_PREV_MON,
	    ...
	    [MOVE_BARK] =
    {
        .name = COMPOUND_STRING("Bark"),
        .description = COMPOUND_STRING(
            "Said to be worse than Bite.\n"
            "Attacks first, may flinch."),
        .effect = EFFECT_HIT,
        .power = 60,
        .type = TYPE_NORMAL,
        .accuracy = 100,
	    ...
	    [MOVE_ZOOMIES] =
    {
        .name = COMPOUND_STRING("Zoomies"),
        .description = COMPOUND_STRING(
            "A frenetic attack that\n"
	    ...
	    [MOVE_GAS_LEAK] =
    {
        .name = COMPOUND_STRING("Gas Leak"),
        .description = COMPOUND_STRING(
            "Does Poison and Fire damage\n"
            "and may burn the target."),
        .effect = EFFECT_TWO_TYPED_MOVE,
        .power = 70,
        .type = TYPE_POISON,
        .accuracy = 95,
