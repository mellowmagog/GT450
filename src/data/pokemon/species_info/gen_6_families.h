...
const struct SpeciesInfo gSpeciesInfoGen6[] =
{
    ...
    [SPECIES_BUNNELBY] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_CHEEK_POUCH, ABILITY_HUGE_POWER, ABILITY_PICKUP },
    ...
    [SPECIES_FLETCHLING] =
    {
        ...
        .abilities = { ABILITY_BIG_PECKS, ABILITY_GALE_WINGS, ABILITY_TOUGH_CLAWS },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_FLETCHINDER] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_FLAME_BODY, ABILITY_GALE_WINGS, ABILITY_TOUGH_CLAWS },
        .bodyColor = BODY_COLOR_RED,
...
#define FLABEBE_MISC_INFO(Form, FORM, iconPal)                                  \
        ...
        .abilities = { ABILITY_SYNCHRONIZE, ABILITY_FLOWER_VEIL, ABILITY_SYMBIOSIS },  \
        .bodyColor = BODY_COLOR_WHITE,                                          \
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 18, SPECIES_FLOETTE_ ##FORM})
...
#define FLOETTE_MISC_INFO(form, FORM, iconPal)                                  \
        ...
        .friendship = STANDARD_FRIENDSHIP,                                      \
        .growthRate = GROWTH_MEDIUM_FAST,                                       \
        .abilities = { ABILITY_SYNCHRONIZE, ABILITY_GRASSY_SURGE, ABILITY_SYMBIOSIS },  \
        .bodyColor = BODY_COLOR_WHITE,                                          \
...
#define AEGISLASH_MAIN_STAT (P_UPDATED_STATS >= GEN_8 ? 140 : 150)
    ...
    [SPECIES_CARBINK] =
    {
        ...
        .abilities = { ABILITY_CLEAR_BODY, ABILITY_MAGIC_BOUNCE, ABILITY_STURDY },
        .bodyColor = BODY_COLOR_GRAY,
