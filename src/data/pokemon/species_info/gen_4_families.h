...
const struct SpeciesInfo gSpeciesInfoGen4[] =
{
    ...
    [SPECIES_CHIMCHAR] =
    {
        ...
        .abilities = { ABILITY_IRON_FIST, ABILITY_FLAME_BODY, ABILITY_BLAZE },
    ...
    [SPECIES_INFERNAPE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_IRON_FIST, ABILITY_FIRE_MANE, ABILITY_BLAZE },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_KRICKETOT] =
    {
        ...
        .abilities = { ABILITY_SOUNDPROOF, ABILITY_SHED_SKIN, ABILITY_RUN_AWAY },
    ...
    [SPECIES_KRICKETUNE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_PUNK_ROCK, ABILITY_TECHNICIAN, ABILITY_SWARM },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_BURMY_PLANT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SHED_SKIN, ABILITY_SHIELD_DUST, ABILITY_OVERCOAT },
        .bodyColor = BODY_COLOR_GREEN,
        .speciesName = _("Burmy"),
        .cryId = CRY_BURMY,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 18, SPECIES_WORMADAM_PLANT, CONDITIONS({IF_GENDER, MON_FEMALE})},
                                {EVO_LEVEL, 18, SPECIES_MOTHIM_PLANT, CONDITIONS({IF_GENDER, MON_MALE})}),
    },
    ...
    [SPECIES_BURMY_SANDY] =
    {
        ...
        .formSpeciesIdTable = sBurmyFormSpeciesIdTable,
        .formChangeTable = sBurmyFormChangeTable,
        .evolutions = EVOLUTION({EVO_LEVEL, 18, SPECIES_WORMADAM_SANDY, CONDITIONS({IF_GENDER, MON_FEMALE})},
                                {EVO_LEVEL, 18, SPECIES_MOTHIM_SANDY, CONDITIONS({IF_GENDER, MON_MALE})}),
    },
    ...
    [SPECIES_BURMY_TRASH] =
    {
        ...
        .formSpeciesIdTable = sBurmyFormSpeciesIdTable,
        .formChangeTable = sBurmyFormChangeTable,
        .evolutions = EVOLUTION({EVO_LEVEL, 18, SPECIES_WORMADAM_TRASH, CONDITIONS({IF_GENDER, MON_FEMALE})},
                                {EVO_LEVEL, 18, SPECIES_MOTHIM_TRASH, CONDITIONS({IF_GENDER, MON_MALE})}),
    },
    ...
    [SPECIES_WORMADAM_PLANT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_FILTER, ABILITY_ADAPTABILITY, ABILITY_OVERCOAT },
        .bodyColor = BODY_COLOR_GREEN,
...
#define MOTHIM_SPECIES_INFO                                                          \
    {                                                                                \
        ...
        .growthRate = GROWTH_MEDIUM_FAST,                                            \
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),                                  \
        .abilities = { ABILITY_COMPOUND_EYES, ABILITY_TINTED_LENS, ABILITY_SWARM },  \
    ...
    [SPECIES_STUNKY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_STENCH, ABILITY_KEEN_EYE, ABILITY_AFTERMATH },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_SKUNTANK] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_STENCH, ABILITY_ARMOR_TAIL, ABILITY_AFTERMATH },
        .bodyColor = BODY_COLOR_PURPLE,
