...
const struct SpeciesInfo gSpeciesInfoGen2[] =
{
    ...
    [SPECIES_LEDYBA] =
    {
        ...
        .abilities = { ABILITY_IRON_FIST, ABILITY_CUTE_CHARM, ABILITY_SWARM },
    ...
    [SPECIES_CHINCHOU] =
    {
        ...
        .abilities = { ABILITY_VOLT_ABSORB, ABILITY_WATER_ABSORB, ABILITY_ILLUMINATE },
        .bodyColor = BODY_COLOR_BLUE,
...
#define TOGEPI_FAMILY_TYPE1 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_NORMAL)
    ...
    [SPECIES_AMPHAROS] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_FIELD),
        .abilities = { ABILITY_STATIC, ABILITY_ELECTROMORPHOSIS, ABILITY_PLUS },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_YANMA] =
    {
        ...
        .evYield_Speed = (P_UPDATED_EVS >= GEN_4) ? 0 : 0,
    ...
    [SPECIES_WOOPER] =
    {
        ...
        .abilities = { ABILITY_WATER_ABSORB, ABILITY_UNAWARE, ABILITY_DAMP },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_WOOPER_PALDEA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_FIELD),
        .abilities = { ABILITY_WATER_ABSORB, ABILITY_UNAWARE, ABILITY_POISON_POINT },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Wooper"),
        .cryId = CRY_WOOPER,
        .natDexNum = NATIONAL_DEX_WOOPER,
    ...
    [SPECIES_MISDREAVUS] =
    {
        ...
        .evYield_SpAttack = (P_UPDATED_EVS >= GEN_4) ? 0 : 0,
        .evYield_SpDefense = 0,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 25,
        .friendship = 35,
...
#if P_FAMILY_UNOWN
#define UNOWN_MISC_INFO(letter, type1, type2, _noFlip, frontWidth, frontHeight, backWidth, backHeight, backYOffset)   \
    {                                                                                                   \
        .baseHP        = 74,                                                                            \
        .baseAttack    = 90,                                                                            \
        .baseDefense   = 92,                                                                            \
    ...
    [SPECIES_UNOWN]             = UNOWN_MISC_INFO(A, TYPE_PSYCHIC, TYPE_GRASS,           FALSE, 24, 40, 24, 48,  8 ),
    [SPECIES_UNOWN_B]           = UNOWN_MISC_INFO(B, TYPE_PSYCHIC, TYPE_BUG,           TRUE,  24, 32, 40, 48,  9 ),
    [SPECIES_UNOWN_C]           = UNOWN_MISC_INFO(C, TYPE_PSYCHIC, TYPE_ICE,           TRUE,  32, 32, 48, 56,  6 ),
    [SPECIES_UNOWN_D]           = UNOWN_MISC_INFO(D, TYPE_PSYCHIC, TYPE_DRAGON,           TRUE,  32, 32, 40, 48,  8 ),
    [SPECIES_UNOWN_E]           = UNOWN_MISC_INFO(E, TYPE_PSYCHIC, TYPE_ELECTRIC,           TRUE,  32, 32, 40, 48, 10 ),
    [SPECIES_UNOWN_F]           = UNOWN_MISC_INFO(F, TYPE_PSYCHIC, TYPE_FIGHTING,           TRUE,  32, 32, 48, 48, 10 ),
    [SPECIES_UNOWN_G]           = UNOWN_MISC_INFO(G, TYPE_PSYCHIC, TYPE_GROUND,           TRUE,  24, 40, 40, 56,  5 ),
    [SPECIES_UNOWN_H]           = UNOWN_MISC_INFO(H, TYPE_PSYCHIC, TYPE_GHOST,           TRUE,  32, 32, 48, 48,  8 ),
    [SPECIES_UNOWN_I]           = UNOWN_MISC_INFO(I, TYPE_PSYCHIC, TYPE_FIRE,           FALSE, 24, 32, 24, 56,  7 ),
    [SPECIES_UNOWN_J]           = UNOWN_MISC_INFO(J, TYPE_PSYCHIC, TYPE_NORMAL,           TRUE,  24, 32, 32, 48,  9 ),
    [SPECIES_UNOWN_K]           = UNOWN_MISC_INFO(K, TYPE_PSYCHIC, TYPE_DARK,           TRUE,  32, 32, 40, 56,  7 ),
    [SPECIES_UNOWN_L]           = UNOWN_MISC_INFO(L, TYPE_PSYCHIC, TYPE_FLYING,           TRUE,  24, 32, 32, 48, 10 ),
    [SPECIES_UNOWN_M]           = UNOWN_MISC_INFO(M, TYPE_PSYCHIC, TYPE_NORMAL,           FALSE, 32, 32, 48, 40, 13 ),
    [SPECIES_UNOWN_N]           = UNOWN_MISC_INFO(N, TYPE_PSYCHIC, TYPE_NORMAL,           TRUE,  32, 24, 48, 40, 13 ),
    [SPECIES_UNOWN_O]           = UNOWN_MISC_INFO(O, TYPE_PSYCHIC, TYPE_NORMAL,           FALSE, 32, 32, 48, 48,  8 ),
    [SPECIES_UNOWN_P]           = UNOWN_MISC_INFO(P, TYPE_PSYCHIC, TYPE_POISON,           TRUE,  24, 32, 32, 48, 10 ),
    [SPECIES_UNOWN_Q]           = UNOWN_MISC_INFO(Q, TYPE_PSYCHIC, TYPE_NORMAL,           TRUE,  32, 24, 40, 40, 15 ),
    [SPECIES_UNOWN_R]           = UNOWN_MISC_INFO(R, TYPE_PSYCHIC, TYPE_ROCK,           TRUE,  24, 32, 32, 40, 12 ),
    [SPECIES_UNOWN_S]           = UNOWN_MISC_INFO(S, TYPE_PSYCHIC, TYPE_STEEL,           TRUE,  32, 40, 40, 56,  4 ),
    [SPECIES_UNOWN_T]           = UNOWN_MISC_INFO(T, TYPE_PSYCHIC, TYPE_NORMAL,           FALSE, 24, 32, 32, 40, 13 ),
    [SPECIES_UNOWN_U]           = UNOWN_MISC_INFO(U, TYPE_PSYCHIC, TYPE_NORMAL,           FALSE, 32, 32, 48, 40, 13 ),
    [SPECIES_UNOWN_V]           = UNOWN_MISC_INFO(V, TYPE_PSYCHIC, TYPE_NORMAL,           TRUE,  32, 32, 40, 48, 11 ),
    [SPECIES_UNOWN_W]           = UNOWN_MISC_INFO(W, TYPE_PSYCHIC, TYPE_WATER,           FALSE, 32, 32, 40, 40, 13 ),
    [SPECIES_UNOWN_X]           = UNOWN_MISC_INFO(X, TYPE_PSYCHIC, TYPE_FAIRY,           FALSE, 24, 24, 40, 40, 15 ),
    [SPECIES_UNOWN_Y]           = UNOWN_MISC_INFO(Y, TYPE_PSYCHIC, TYPE_NORMAL,           FALSE, 24, 32, 32, 48, 10 ),
    [SPECIES_UNOWN_Z]           = UNOWN_MISC_INFO(Z, TYPE_PSYCHIC, TYPE_NORMAL,           TRUE,  24, 32, 32, 48, 10 ),
    [SPECIES_UNOWN_EXCLAMATION] = UNOWN_MISC_INFO(Exclamation, TYPE_PSYCHIC, TYPE_NORMAL, FALSE, 24, 40, 24, 56,  6 ),
    [SPECIES_UNOWN_QUESTION]    = UNOWN_MISC_INFO(Question, TYPE_PSYCHIC, TYPE_NORMAL,    TRUE,  24, 40, 32, 56,  6 ),
    ...
    [SPECIES_DUNSPARCE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SERENE_GRACE, ABILITY_EMERGENCY_EXIT, ABILITY_RATTLED },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_QWILFISH] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_2),
        .abilities = { ABILITY_POISON_POINT, ABILITY_INTIMIDATE, ABILITY_SWIFT_SWIM },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_SNEASEL] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_INNER_FOCUS, ABILITY_TOUGH_CLAWS, ABILITY_PICKPOCKET },
        .bodyColor = BODY_COLOR_BLACK,
        .noFlip = TRUE,
    ...
    [SPECIES_WEAVILE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_PRESSURE, ABILITY_TOUGH_CLAWS, ABILITY_PICKPOCKET },
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_SNEASLER] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_UNBURDEN, ABILITY_TOUGH_CLAWS, ABILITY_POISON_TOUCH },
        .bodyColor = BODY_COLOR_BLUE,
        .noFlip = TRUE,
    ...
    [SPECIES_TEDDIURSA] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_CUTE_CHARM, ABILITY_QUICK_FEET, ABILITY_UNNERVE },
    #else
    ...
    [SPECIES_URSARING] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_GUTS, ABILITY_TOUGH_CLAWS, ABILITY_UNNERVE },
    #else
    ...
    [SPECIES_PHANPY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_DRY_SKIN, ABILITY_STURDY, ABILITY_SAND_VEIL },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_DONPHAN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SPEED_BOOST, ABILITY_STAMINA, ABILITY_SAND_VEIL },
        .bodyColor = BODY_COLOR_GRAY,
