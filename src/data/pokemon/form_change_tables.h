...
{
    {FORM_CHANGE_ITEM_HOLD, SPECIES_UNOWN_N,   ITEM_NONE,         ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_UNOWN_F, ITEM_FIST_PLATE,   ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_UNOWN_L,   ITEM_SKY_PLATE,    ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_UNOWN_P,   ITEM_TOXIC_PLATE,  ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_UNOWN_R,     ITEM_STONE_PLATE,  ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_UNOWN_G,   ITEM_EARTH_PLATE,  ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_UNOWN_B,      ITEM_INSECT_PLATE, ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_UNOWN_H,    ITEM_SPOOKY_PLATE, ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_UNOWN_S,    ITEM_IRON_PLATE,   ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_UNOWN_I,     ITEM_FLAME_PLATE,  ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_UNOWN_W,    ITEM_SPLASH_PLATE, ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_UNOWN,    ITEM_MEADOW_PLATE, ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_UNOWN_E, ITEM_ZAP_PLATE,    ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_UNOWN_QUESTION,  ITEM_MIND_PLATE,   ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_UNOWN_C,      ITEM_ICICLE_PLATE, ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_UNOWN_D,   ITEM_DRACO_PLATE,  ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_UNOWN_K,     ITEM_DREAD_PLATE,  ABILITY_MULTITYPE},
    {FORM_CHANGE_ITEM_HOLD, SPECIES_UNOWN_X,    ITEM_PIXIE_PLATE,  ABILITY_MULTITYPE},
    {FORM_CHANGE_TERMINATOR},
};
