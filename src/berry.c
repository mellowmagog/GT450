...
const struct Berry gBerries[NUM_BERRIES + 1] =
{
    ...
    [BERRY_ID_CHERI] =
    {
        .info = {
            ...
            .size = 20,
            .maxYield = YIELD_RATE(19, 15, 45, 60),
            .minYield = YIELD_RATE(5, 6, 12, 12),
    ...
    [BERRY_ID_CHESTO] =
    {
        .info = {
            ...
            .size = 80,
            .maxYield = YIELD_RATE(19, 5, 15, 20),
    ...
    [BERRY_ID_ORAN] =
    {
        .info = {
            ...
            .size = 35,
            .maxYield = YIELD_RATE(38, 15, 45, 60),
            .minYield = YIELD_RATE(9, 6, 12, 12),
    ...
    [BERRY_ID_STARF] =
    {
        .info = {
            ...
            .color = BERRY_COLOR_GREEN,
            .size = 153,
            .maxYield = YIELD_RATE(23, 5, 5, 7),
            .minYield = YIELD_RATE(11, 1, 1, 1),
