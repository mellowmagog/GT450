...
#define GRASS_STARTER (IS_FRLG ? SPECIES_BULBASAUR  : SPECIES_BOUNSWEET)
#define FIRE_STARTER  (IS_FRLG ? SPECIES_CHARMANDER : SPECIES_KOFFING)
#define WATER_STARTER (IS_FRLG ? SPECIES_SQUIRTLE   : SPECIES_TRAPINCH )
